...
//we will call this function while add, delete and check-uncheck the task
function allTasks() {
...
//add task while we put value in text area and then press enter
...
//check and uncheck the checkbox while we click on the task
...
//delete all the tasks while we click on the clear button.
